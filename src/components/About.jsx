        ...
        <Section id="about" className="bg-zinc-900/50 md:px-12 lg:px-20">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                <div className="mb-8 md:mb-0">
                    ...
                    <p className="text-zinc-400 leading-relaxed mb-4">
                        With a strong foundation in <span className="text-white">Full Stack Development</span>, I specialize in building scalable mobile applications. My expertise spans across Node.js, Express.js, Springboot and Flutter, backed by robust database knowledge in MongoDB, PostgreSQL, and Redis.
                    </p>
